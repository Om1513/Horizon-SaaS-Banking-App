                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            {type === 'sign-up' && (
                                ...
                                <div className='flex gap-4'>
                                    ...
                                    <CustomInput control={form.control} name={"postalCode"} label={"Postal Code"} placeholder={"ex. 11220"}/>
                                </div>
                                <div className='flex gap-4'>
                                    <CustomInput control={form.control} name={"dateOfBirth"} label={"Date of Birth"} placeholder={"YYYY-mm-dd"}/>
                                    <CustomInput control={form.control} name={"ssn"} label={"SSN"} placeholder={"ex. 123-45-7890"}/>
                                </div>
                                </>
                            )}
